...
public class Program {
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("Введите: Фамилия Имя Отчество Дата рождения номер телефона пол (через пробел)");
    ...
    public static Formatter CV (String[] s) throws Exception{
        ...
        if (s.length > 6) {
            throw new NullPointerException("Должно быть меньше символов!");
        }
        if (s.length < 6) {
            throw new NullPointerException("Должно быть больше символов!");
        }
        ...
        if (surname == null || name == null || middleN == null) {
            throw new NullPointerException("'ФИО' is incorrect");
        }
        if (birthD == null) {
            throw new NullPointerException("'Дата рождения' is incorrect, pls, enter dd.mm.yyyy");
        }
        if (telN == 0) {
            throw new NumberFormatException("'Номер телефона' is incorrect, pls, enter 11 digits");
        }
        if (gender == 0) {
            throw new NullPointerException("'Пол' is incorrect, pls, enter 'm' or 'f'");
        }
